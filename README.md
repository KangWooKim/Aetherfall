...
| 읽을 순서 | 문서 | 확인할 내용 |
| --- | --- | --- |
| 1 | [프로젝트 개요와 아키텍처](Docs/03_Technical/ProjectOverview.md) | 게임 흐름, 계층별 책임, 수명, 기술 환경 |
...
모델·애니메이션·VFX·음향·환경에는 Marketplace/Fab 자산을 활용했습니다. 기본 대화 TTS는 시간 기반 Mock이며, 적 행동은 C++의 이동·회전과 공격 상태 처리로 구성했습니다.
